...
public class DialogueManager : MonoBehaviour
{
    ...
    public Dictionary<string, string[]> triggersToDialogue = new Dictionary<string, string[]>{
        ...
        "That fears a painted devil. If he do bleed,", "I'll gild the faces of the grooms withal;", "For it must seem their guilt.", "[Exit. Knocking within]"}}, 
        ...
        "Will all great Neptune's ocean wash this blood", "Clean from my hand? No, this my hand will rather", "The multitudinous seas in incarnadine,", "Making the green one red.", "[Re-enter LADY MACBETH]"}},
        {"[Re-enter LADY MACBETH]", new [] {"LADY MACBETH", "My hands are of your colour; but I shame", "To wear a heart so white."}},
        {"...", new [] {"LADY MACBETH", "I hear a knocking", "At the south entry: retire we to our chamber;", "A little water clears us of this deed:", "How easy is it, then! Your constancy",
        "Hath left you unattended."}},
        {"... I...", new [] {"LADY MACBETH", "Hark! more knocking.", "Get on your nightgown, lest occasion call us,", "And show us to be watchers. Be not lost",
        "So poorly in your thoughts."}},
        {"I don't want to see who I've become...", new [] {"MACBETH", "To know my deed, 'twere best not know myself.", "[Knocking within]", "Wake Duncan with thy knocking! I would thou couldst!"}}
    };
